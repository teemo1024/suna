...
export const FreebeatThreadContent: React.FC<ThreadContentProps> = ({
  messages,
                                  ...
                                  if (message.type === 'assistant') {
                                    ...
                                    elements.push(
                                      <div key={msgKey} className={msgIndex > 0 ? 'mt-2' : ''}>
                                        <div className="prose prose-sm dark:prose-invert chat-markdown max-w-none [&>:first-child]:mt-0 prose-headings:mt-3">{renderedContent}</div>
                                      </div>,
                                    );
                                  }
                                });
...
export default FreebeatThreadContent;
